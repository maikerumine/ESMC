...
public class UtilityGL11Debug
{
    public class GLproperty
    {
         ...
         *
         * @param init_gLconstant
         *            the init g lconstant
         * @param init_name
         *            the init name
         * @param init_description
         *            the init description
         * @param init_category
         *            the init category
         * @param init_fetchCommand
         *            the init fetch command
         */
    ...
    public GLproperty[] propertyList = {
            ...
            new GLproperty(GL11.GL_CURRENT_RASTER_TEXTURE_COORDS, "GL_CURRENT_RASTER_TEXTURE_COORDS", "Texture coordinates associated with raster position",
                    "current", "glGetFloatv()"),
            new GLproperty(GL11.GL_CURRENT_RASTER_POSITION_VALID, "GL_CURRENT_RASTER_POSITION_VALID", "Raster position valid bit", "current",
                    "glGetBooleanv()"),
            ...
            new GLproperty(GL11.GL_MAX_ATTRIB_STACK_DEPTH, "GL_MAX_ATTRIB_STACK_DEPTH", "Maximum depth of the attribute stack", "capability",
                    "glGetIntegerv()"),
    ...
    private static String getPropertyAsString(int propertyListIndex)
    {
        ...
        /*
         * case "glGetBooleanv()": { System.out.println(GL11.glGetBooleanv()); break;} case "glGetFloatv()": { System.out.println(GL11.glGetFloatv()); break;} case
         * "glGetIntegerv()": { System.out.println(GL11.glGetIntegerv()); break;} case "glGetLightfv()": { System.out.println(GL11.glGetLightfv()); break;} case "glGetMapfv()": {
         * System.out.println(GL11.glGetMapfv()); break;} case "glGetMapiv()": { System.out.println(GL11.glGetMapiv()); break;} case "glGetMaterialfv()": {
         * System.out.println(GL11.glGetMaterialfv()); break;} case "glGetPixelMap*()": { System.out.println(GL11.glGetPixelMap*()); break;} case "glGetPointerv()": {
         * System.out.println(GL11.glGetPointerv()); break;} case "glGetTexEnvfv()": { System.out.println(GL11.glGetTexEnvfv()); break;} case "glGetTexEnviv()": {
         * System.out.println(GL11.glGetTexEnviv()); break;} case "glGetTexGenfv()": { System.out.println(GL11.glGetTexGenfv()); break;} case "glGetTexGeniv()": {
         * System.out.println(GL11.glGetTexGeniv()); break;} case "glGetTexImage()": { System.out.println(GL11.glGetTexImage()); break;} case "glGetTexLevelParameter*()": {
         * System.out.println(GL11.glGetTexLevelParameter*()); break;} case "glGetTexParameter*()": { System.out.println(GL11.glGetTexParameter*()); break;} case
         * "glGetTexParameteriv()": { System.out.println(GL11.glGetTexParameteriv()); break;}
         */
    }
