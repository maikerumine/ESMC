...
public class ModConfiguration 
{
	...
	public static void init(File file)
	{
		...
		ENTITY_STONEMONSTER_ID = config.getInt("ENTITY_CENTAUR_ID", category, 201, 201, 999, "Entity IDs below 201 are used by Minecraft");
		
		category = "GUI IDs";
		config.addCustomCategoryComment(category, "Set the ID's for the GUI's to ensure that they don't clash with other mod's ids");

		GUI_ESM_CHEST_ID = config.getInt("GUI_COPPER_CHEST_ID", category, 4, 1, 999, "Set the ID for the Copper Chest");
