...
public class BiomeCold_desert_ocean extends Biome 
{
	public BiomeCold_desert_ocean() 
	{
		...
		super(new BiomeProperties("ESM Cold_desert_ocean").func_185398_c(-1.0F).func_185400_d(0.1F).func_185410_a(0.0F).func_185395_b(0.5F).func_185411_b());
