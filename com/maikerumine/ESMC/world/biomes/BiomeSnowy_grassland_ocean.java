...
public class BiomeSnowy_grassland_ocean extends Biome 
{
	public BiomeSnowy_grassland_ocean() 
	{
		super(new BiomeProperties("MT Snowy_grassland_ocean").func_185398_c(-1.8F).func_185400_d(0.1F));
