...
public class BiomeGrassland_ocean extends Biome 
{
	public BiomeGrassland_ocean() 
	{
		super(new BiomeProperties("MT Grassland Ocean").func_185398_c(-1.0F).func_185400_d(0.1F));
