...
public class BiomeSandstone_desert extends Biome 
{
	public BiomeSandstone_desert() 
	{
		...
		super(new BiomeProperties("MT Sandstone Desert").func_185410_a(2.0F).func_185395_b(0.0F).func_185396_a());
