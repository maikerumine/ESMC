...
public class BiomeDeciduous_forest_ocean extends Biome 
{
	public BiomeDeciduous_forest_ocean() 
	{
		super(new BiomeProperties("MT Deciduous_forest_ocean").func_185398_c(-1.0F).func_185400_d(0.1F));
