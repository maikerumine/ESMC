...
public class BiomeConiferous_forest extends Biome 
{
	public BiomeConiferous_forest() 
	{
		super(new BiomeProperties("MT Coniferous_forest").func_185410_a(0.7F).func_185395_b(0.8F));
