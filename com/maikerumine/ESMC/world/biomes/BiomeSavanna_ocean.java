...
public class BiomeSavanna_ocean extends Biome 
{
	public BiomeSavanna_ocean() 
	{
		...
		super(new BiomeProperties("MT Savanna_ocean").func_185398_c(-1.8F).func_185400_d(0.1F));
