...
public class BiomeConiferous_forest_ocean extends Biome 
{
	public BiomeConiferous_forest_ocean() 
	{
		super(new BiomeProperties("MT Coniferous_forest_ocean").func_185398_c(-1.0F).func_185400_d(0.1F));
