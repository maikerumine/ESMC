...
public class ChunkGeneratorNetherTemplate implements IChunkGenerator
{
    ...
    protected static final IBlockState MAIN_BLOCK = Blocks.field_150342_X.func_176223_P();
    //Block that is usally Lava
    protected static final IBlockState YOUR_LIQUID = Blocks.field_150355_j.func_176223_P();
    //Blocks that are usally gravel and soul sand
    protected static final IBlockState OTHER_BLOCK1 = Blocks.field_150359_w.func_176223_P();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.field_150352_o.func_176223_P();
    ...
    */
    ...
    private final WorldGenHellLava hellSpringGen = new WorldGenHellLava(Blocks.field_150358_i, false);
    ...
    public void buildSurfaces(int x, int z, ChunkPrimer primer)
    {
        ...
        double d0 = 0.03125D;
        this.slowsandNoise = this.slowsandGravelNoiseGen.func_76304_a(this.slowsandNoise, x * 16, z * 16, 0, 16, 16, 1, 0.03125D, 0.03125D, 1.0D);
        this.gravelNoise = this.slowsandGravelNoiseGen.func_76304_a(this.gravelNoise, x * 16, 109, z * 16, 16, 1, 16, 0.03125D, 1.0D, 0.03125D);
        this.depthBuffer = this.netherrackExculsivityNoiseGen.func_76304_a(this.depthBuffer, x * 16, z * 16, 0, 16, 16, 1, 0.0625D, 0.0625D, 0.0625D);
            ...
            for (int k = 0; k < 16; ++k)
            {
                ...
                for (int j1 = 127; j1 >= 0; --j1)
                {
                    if (j1 < 127 - this.rand.nextInt(5) && j1 > this.rand.nextInt(5))
                    {
                        ...
                        {
                            if (iblockstate2.func_177230_c() == MAIN_BLOCK.func_177230_c())
                            {
                                if (i1 == -1)
                                {
                                    if (l <= 0)
    ...
    private double[] getHeights(double[] noiseField, int x, int y, int z, int xSize, int ySize, int zSize)
    {
        ...
        double d0 = 684.412D;
        double d1 = 2053.236D;
        this.noiseData4 = this.scaleNoise.func_76304_a(this.noiseData4, x, y, z, xSize, 1, zSize, 1.0D, 0.0D, 1.0D);
        this.dr = this.depthNoise.func_76304_a(this.dr, x, y, z, xSize, 1, zSize, 100.0D, 0.0D, 100.0D);
        this.pnr = this.perlinNoise1.func_76304_a(this.pnr, x, y, z, xSize, ySize, zSize, 8.555150000000001D, 34.2206D, 8.555150000000001D);
        this.ar = this.lperlinNoise1.func_76304_a(this.ar, x, y, z, xSize, ySize, zSize, 684.412D, 2053.236D, 684.412D);
        this.br = this.lperlinNoise2.func_76304_a(this.br, x, y, z, xSize, ySize, zSize, 684.412D, 2053.236D, 684.412D);
        int i = 0;
    ...
    public void func_185931_b(int x, int z)
    {
        ...
        {
            for (int k = 0; k < 8; ++k) { this.hellSpringGen.func_180709_b(this.world, this.rand, blockpos.func_177982_a(this.rand.nextInt(16) + 8, this.rand.nextInt(120) + 4, this.rand.nextInt(16) + 8)); }
        }
