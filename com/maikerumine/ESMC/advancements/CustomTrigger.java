...
*/
package com.maikerumine.ESMC.advancements;
...
public class CustomTrigger implements ICriterionTrigger<CustomTrigger.Instance>
{
     ...
     */
    @Override
    public void func_192165_a(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<CustomTrigger.Instance> listener)
    {
     ...
     */
    @Override
    public void func_192164_b(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<CustomTrigger.Instance> listener)
    {
     ...
     */
    @Override
    public CustomTrigger.Instance func_192166_a(JsonObject json, JsonDeserializationContext context)
    {
        return new CustomTrigger.Instance(func_192163_a());
    }
    ...
    {
        CustomTrigger.Listeners tameanimaltrigger$listeners = listeners.get(parPlayer.func_192039_O());
    ...
    static class Listeners
    {
        ...
        public void trigger(EntityPlayerMP player)
        {
            ...
            {
                if (listener.func_192158_a().test())
                {
                    if (list == null)
                    {
